...
import by.epam.newsmanagement.utils.LocalDateAttributeConverter;

@Entity
@Table(name = "NEWS")
@NamedQueries({@NamedQuery(name = "getAllNews", query = "SELECT news FROM News news"),})
public class News implements Serializable {
  ...
  @ManyToMany
  @JoinTable(name = "NEWS_TAG", joinColumns = @JoinColumn(name = "FK_NEWS"),
  ...
  public String toString() {
    return "News [id=" + id + ", mainTitle=" + mainTitle + ", shortTitle=" + shortTitle
        + ", content=" + content + ", author=" + author + ", publicationDate=" + publicationDate
        + ", modificationDate=" + modificationDate + ", pathToPhoto=" + pathToPhoto + ", views="
        + views + ", tagList=" + tagList + ", commentsList=" + commentsList + "]";
  }
}
